  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--muted)', fontSize: '.875rem', marginBottom: '1rem' }}>
        Vista consolidada desde la VIEW <code style={{ background: 'rgba(124,111,250,.12)', padding: '1px 6px', borderRadius: 4, color: '#a89dfc' }}>reporte_ventas</code>.
      </p>
      {!data ? <ErrorCard /> : (
        <div className="card">
              ...
              <tbody>
                {data.length === 0 ? (
                  ...
                  <tr key={i}>
                    ...
                    <td>{r[1]}</td>
                    <td><strong style={{ color: 'var(--accent)' }}>Q{Number(r[2]).toFixed(2)}</strong></td>
