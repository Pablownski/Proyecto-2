  ...
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
        ...
        {!showAdd && !editId && (
          <Link href="/admin/gestion-clientes?add=1" className="btn btn-success btn-sm">+ Agregar Cliente</Link>
        )}
      </div>
                ...
                <tr key={r[0]} className={editId === r[0] ? 'editing' : ''}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '.4rem' }}>
                      <Link href={`/admin/gestion-clientes?edit=${r[0]}`} className="btn btn-warning btn-sm">Editar</Link>
